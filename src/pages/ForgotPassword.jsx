...
import { recoverPassword } from '../services/api/mailer'
...
function ForgotPassword() {
  ...
  return (
    <Card style={{ width: '300px' }}>
      <Card.Body>
        <Card.Title className="mb-3 text-center">{t('FORGOT_PASSWORD')}</Card.Title>
        <Card.Subtitle className="mb-3 text-center">{t('FORGOT_PASSWORD_DESCRIPTION')}</Card.Subtitle>
